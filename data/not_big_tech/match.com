...
Effective on 2021-02-08; click here to download a PDF

California subscribers: You may cancel your subscription, without penalty or obligation, at any time prior to midnight of the third business day following the date you subscribed. If you subscribed using an External Service (e.g., Apple ID, Google Play), you must cancel through your External Service, as set forth in more detail in Section 8a. If you subscribed through your Apple ID, refunds are handled by Apple/Google, not Match. You can request a refund from Apple through your Apple ID account on your phone or at https://getsupport.apple.com. All other users may request a refund by contacting Match Customer Service at by clicking here, or by mailing or delivering a signed and dated notice that states that you, the buyer, are canceling this agreement, or words of similar effect. Please also include your name and the email address, phone number, or other unique identifier you used to sign up for your account. This notice shall be sent to: Match, Attn: Cancellations, P.O. Box 25472, Dallas, Texas 75225, USA. The Company’s business is conducted, in part, at 8750 N. Central Expressway, Suite 1400, Dallas, TX 75205. You may have these terms of use e-mailed to you by sending a letter to Terms Inquiries, P.O. Box 25472, Dallas, Texas 75225, USA. In accordance with Cal. Civ. Code §1789.3, you may report complaints to the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs by contacting them in writing at Consumer Information Division, 1625 North Market Blvd., Suite N112 Sacramento, CA 95834, or by telephone at (800) 952-5210.
...
By accessing or using Match’s services, you agree to be bound by these terms, including our Privacy and Cookie Policies, so it is important that you read this agreement carefully before you create an account. We may update the terms from time to time, so you should check this page regularly for updates.

Welcome to Match, operated by Match Group, LLC, in the case of users originating from within the United States and Canada, and Match.com Global Services Limited, in the case of users originating from outside of the United States and Canada. As used in this Agreement, the terms “Match,” “us,” “we,” the “Company”, and “our” shall refer to Match Group, LLC and/or Match.com Global Services Limited, as appropriate.

By accessing or using our Services on match.com (the “Website”), the Match mobile application (the “App”), or any other platforms or services Match may offer (collectively, the “Service” or our “Services”), you agree to, and are bound by, these Terms of Use (the “Terms” or “Agreement”). This Agreement applies to anyone who accesses or uses our Services, regardless of registration or subscription status.

Your use of our Services is also subject to the Privacy Policy, Cookie Policy, and any terms disclosed and agreed to by you when you purchase additional features, products, or services from Match (“Additional Terms Upon Purchase”), which are incorporated into this Agreement by reference. If you do not wish to be bound by this Agreement, do not use our Services.
...
Before you create an account on Match, make sure you are eligible to use our Services. This Section also details what you can and can’t do when using the Services, as well as the rights you grant Match.
...
You agree that you will not:
    ...
    Violate the terms of the license granted to you by Match (see Section 6 below).
    Disclose private or proprietary information that you do not have the right to disclose;
    Copy, modify, transmit, distribute, or create any derivative works from, any Member Content or Our Content, or any copyrighted material, images, trademarks, trade names, service marks, or other intellectual property, content or proprietary information accessible through our Services without Match’s prior written consent;
    Express or imply that any statements you make are endorsed by Match;
    ...
    “Frame” or “mirror” any part of our Services without Match’s prior written authorization;
    ...
    Use, access, or publish the Match application programming interface without our written consent;
...
Prohibited Content—Match prohibits uploading or sharing content that:
    ...
    Was not written by you or was automatically generated, unless expressly authorized by Match;
    ...
    May harm the reputation of Match or its affiliates.
...
While using our Services, you will have access to: (i) content that you upload or provide while using our Services (“Your Content”); (ii) content that other users upload or provide while using our Services (“Member Content”); and (iii) content that Match provides on and through our Services (“Our Content”). In this agreement, “content” includes, without limitation, all text, images, video, audio, or other material on our Services, including information on users’ profiles and in direct messages between users.
3a. YOUR CONTENT
...
Match owns all other content on our Services.
...
Match does not tolerate inappropriate content or behavior on our Services.

We are committed to maintaining a positive and respectful Match community, and we do not tolerate any inappropriate content or misconduct, whether on or off of the Services. We encourage you to report any inappropriate Member Content or misconduct by other users. You can report a user directly through the “Report a Concern” link on a user’s profile or at the bottom of every email. You may also email Match Customer Service by clicking here.
...
For information about how Match and its affiliates collect, use, and share your personal data, please read our Privacy Policy . By using our Services, you agree that we may use your personal data in accordance with our Privacy Policy .
6. RIGHTS YOU ARE GRANTED BY MATCH

Match grants you the right to use and enjoy our Services, subject to these Terms.

For as long as you comply with these Terms, Match grants you a personal, worldwide, royalty-free, non-assignable, non-exclusive, revocable, and non-sublicensable license to access and use our Services for purposes as intended by Match and permitted by these Terms and applicable laws.
7. RIGHTS YOU GRANT MATCH

You own all of the content you provide to Match, but you also grant us the right to use Your Content as provided in this Agreement.

By creating an account, you grant to Match a worldwide, perpetual, transferable, sub-licensable, royalty-free right and license to host, store, use, copy, display, reproduce, adapt, edit, publish, translate, modify, and distribute Your Content, including any information you authorize us to access from Facebook or other third-party source (if applicable), in whole or in part, and in any format or medium currently known or developed in the future. Match’s license to Your Content shall be non-exclusive, except that Match’s license shall be exclusive with respect to derivative works created through use of our Services. For example, Match would have an exclusive license to screenshots of our Services that include Your Content.

In addition, so that Match can prevent the use of Your Content outside of our Services, you authorize Match to act on your behalf with respect to infringing uses of Your Content taken from our Services by other users or third parties. This expressly includes the authority, but not the obligation, to send notices pursuant to 17 U.S.C. § 512(c)(3) (i.e., DMCA Takedown Notices) on your behalf if Your Content is taken and used by third parties outside of our Services. Match is not obligated to take any action with regard to use of Your Content by other users or third parties. Match’s license to Your Content is subject to your rights under applicable law (for example, laws regarding personal data protection to the extent the content contains personal information as defined by those laws).

In consideration for Match allowing you to use our Services, you agree that we, our affiliates, and our third-party partners may place advertising on our Services. By submitting suggestions or feedback to Match regarding our Services, you agree that Match may use and share such feedback for any purpose without compensating you.

You agree that Match may access, preserve, and disclose your account information, including Your Content, if required to do so by law or upon a good faith belief that such access, preservation, or disclosure is reasonably necessary to: (i) comply with legal process; (ii) enforce these Terms; (iii) respond to claims that any content violates the rights of third parties; (iv) respond to your requests for customer service; or (v) protect the rights, property or personal safety of the Company or any other person.
8. PURCHASES AND AUTOMATICALLY RENEWING SUBSCRIPTIONS

You will have the opportunity to purchase products and services from Match. If you purchase a subscription, it will automatically renew—and you will be charged—until you cancel.

Match may offer products and services for purchase through iTunes, Google Play or other external services authorized by Match (each, an “External Service,” and any purchases made thereon, an “External Service Purchase”). Match may also offer products and services for purchase via credit card or other payment processors on the Website or inside the App (“Internal Purchases”). If you purchase a subscription, it will automatically renew until you cancel, in accordance with the terms disclosed to you at the time of purchase, as further described below. If you cancel your subscription, you will continue to have access to your subscription benefits until the end of your subscription period, at which point it will expire.
...
From time to time, you may have the opportunity purchase a limited, personal, non-transferable, non-sublicensable, revocable license to use or access special limited-use features such as “Boost” (“Virtual Item(s)”) from Match. You may only purchase Virtual Items from us or our authorized partners through our Services. Virtual Items represent a limited license right governed by this Agreement, and, except as otherwise prohibited by applicable law, no title or ownership in or to Virtual Items is being transferred or assigned to you. This Agreement should not be construed as a sale of any rights in Virtual Items.

Any Virtual Item balance shown in your account does not constitute a real-world balance or reflect any stored value, but instead constitutes a measurement of the extent of your license. Virtual Items do not incur fees for non-use; however, the license granted to you in Virtual Items will terminate in accordance with the terms of this Agreement, on the earlier of when Match ceases providing our Services, or your account is otherwise closed or terminated.

Match, in its sole discretion, reserves the right to charge fees for the right to access or use Virtual Items and/or may distribute Virtual Items with or without charge. Match may manage, regulate, control, modify, or eliminate Virtual Items at any time, including taking actions that may impact the perceived value or purchase price, if applicable, of any Virtual Items. Match shall have no liability to you or any third party in the event that Match exercises any such rights. The transfer of Virtual Items is prohibited, and you shall not sell, redeem, or otherwise transfer Virtual Items to any person or entity. Virtual Items may only be redeemed through our Services.

ALL PURCHASES AND REDEMPTIONS OF VIRTUAL ITEMS MADE THROUGH OUR SERVICES ARE FINAL AND NON-REFUNDABLE. YOU ACKNOWLEDGE THAT MATCH IS NOT REQUIRED TO PROVIDE A REFUND FOR ANY REASON, AND THAT YOU WILL NOT RECEIVE MONEY OR OTHER COMPENSATION FOR UNUSED VIRTUAL ITEMS WHEN AN ACCOUNT IS CLOSED, WHETHER SUCH CLOSURE WAS VOLUNTARY OR INVOLUNTARY.
8d. REFUNDS
...
If any of the above apply to you and you subscribed using your Apple ID, your refund requests are handled by Apple, not Match. To request a refund, please contact your External Service directly; for example using your Apple device, go to Settings > iTunes & App Stores > [click on your Apple ID] > View Apple ID > Purchase History. Find the transaction and select “Report a Problem.” You can also request a refund at https://getsupport.apple.com. For any other purchase, please contact Match Customer Service with your order number (see your confirmation email) by mailing or delivering a signed and dated notice which states that you, the buyer, are canceling this agreement, or words of similar effect. Please also include the email address or telephone number associated with your account along with your order number. This notice shall be sent to: Match, Attn: Cancellations, P.O. Box 25472, Dallas, Texas 75225, USA (California and Ohio users may also email us by clicking here or send a facsimile to 214-853-4309).
8e. INSTALLMENT PLAN CONDITIONS

If you agree to make a purchase pursuant to the installment plan option, your purchase will be subject to these additional terms and conditions, including around eligibility, payment, and cancellation.

By selecting the option to pay in four payments and clicking subscribe, in addition to the terms set forth above, you agree to the following additional terms that will govern your installment plan purchase:

    Eligibility. To be eligible, you must be a Match member in good standing residing in the United States of America. This offer may not be available to every customer and may not be available for all Services Match offers. Match will not use a consumer credit report to determine your eligibility for this Agreement.

    Payment. You authorize Match to charge the Payment Method selected on a periodic basis (as determined when you register). You will be charged the full price of the qualifying product you selected spread equally over one initial payment due at the time of purchase and three subsequent payments (provided, however, that if the full price is not evenly divisible by four, your final payment amount may be smaller).The three subsequent payments will be charged in the increments you selected as part of your subscription plan. No interest or finance charges apply to this installment plan purchase. Any interest, finance charges or fees assessed by the issuer of your Payment Method may still apply. You are personally responsible for any applicable state, federal or other taxes that may be associated with your purchase of Services unless noted otherwise.

    You can choose to prepay your next schedule payment or the full remaining balance at any time by contacting Customer Care.

    Match’s right to Terminate. If Match is not able to charge any payment to your Payment Method, Match reserves the right to pursue any remedy that is available to it, including the right to suspend or terminate your Match subscription and/or Match account. You agree that Match and its affiliates have no liability related to the exercise of these remedies.

    Cancellation Policy. Except as otherwise set forth herein, your subscription purchased through your installment plan will continue until terminated, cancelled, or not renewed by you or Match, as further described in this Agreement. If not terminated, cancelled, or not renewed, your Membership will continue to renew with installment payments, until you cancel or change your payment options, via your Account Settings. If you cancel a subscription, you may continue to use the cancelled service until the end of your then-current subscription term. The subscription will not be renewed when your then-current term expires. If you cancel your subscription prior to completing all payments due, unless otherwise required by applicable law, the remaining balance of the subscription will remain due and payable pursuant to the installment payment schedule you agreed to.
...
If your account is terminated by you or by Match for any reason, these Terms continue and remain enforceable between you and Match, and you will not be entitled to any refund for purchases made. Your information will be maintained and deleted in accordance with our Privacy Policy.
10. NO CRIMINAL BACKGROUND OR IDENTITY VERIFICATION CHECKS

Match does not conduct criminal background or identity verification checks on its users. Use your best judgment when interacting with others and check out our Safety Tips.

YOU UNDERSTAND THAT MATCH DOES NOT CONDUCT CRIMINAL BACKGROUND OR IDENTITY VERIFICATION CHECKS ON ITS USERS OR OTHERWISE INQUIRE INTO THE BACKGROUND OF ITS USERS. MATCH MAKES NO REPRESENTATIONS OR WARRANTIES AS TO THE CONDUCT, IDENTITY, INTENTIONS, LEGITIMACY, OR VERACITY OF USERS. MATCH RESERVES THE RIGHT TO CONDUCT—AND YOU AUTHORIZE MATCH TO CONDUCT—ANY CRIMINAL BACKGROUND CHECK OR OTHER SCREENINGS (SUCH AS SEX OFFENDER REGISTER SEARCHES) AT ANY TIME USING AVAILABLE PUBLIC RECORDS, AND YOU AGREE THAT ANY INFORMATION YOU PROVIDE MAY BE USED FOR THAT PURPOSE. IF THE COMPANY DECIDES TO CONDUCT ANY SCREENING THROUGH A CONSUMER REPORTING AGENCY, YOU HEREBY AUTHORIZE THE COMPANY TO OBTAIN AND USE A CONSUMER REPORT ABOUT YOU TO DETERMINE YOUR ELIGIBILITY UNDER THESE TERMS.

YOU ARE SOLELY RESPONSIBLE FOR YOUR INTERACTIONS WITH OTHER USERS. SEX OFFENDER SCREENINGS AND OTHER TOOLS DO NOT GUARANTEE YOUR SAFETY AND ARE NOT A SUBSTITUTE FOR FOLLOWING THE SAFETY TIPS AND OTHER SENSIBLE SAFETY PRECAUTIONS. ALWAYS USE YOUR BEST JUDGMENT AND TAKE APPROPRIATE SAFETY PRECAUTIONS WHEN COMMUNICATING WITH OR MEETING NEW PEOPLE. COMMUNICATIONS RECEIVED THROUGH THE SERVICE, INCLUDING AUTOMATIC NOTIFICATIONS SENT BY MATCH, MAY RESULT FROM USERS ENGAGING WITH THE SERVICE FOR IMPROPER PURPOSES, INCLUDING FRAUD, ABUSE, HARASSMENT, OR OTHER SUCH IMPROPER BEHAVIOR.

Though Match strives to encourage a respectful user experience, it is not responsible for the conduct of any user on or off the Service. You agree to use caution in all interactions with other users, particularly if you decide to communicate off the Service or meet in person.
11. DISCLAIMER

Match’s Services are provided “as is” and we do not make, and cannot make, any representations about the content or features of our Services.

MATCH PROVIDES OUR SERVICES ON AN “AS IS” AND “AS AVAILABLE” BASIS AND TO THE EXTENT PERMITTED BY APPLICABLE LAW, GRANTS NO WARRANTIES OF ANY KIND, WHETHER EXPRESS, IMPLIED, STATUTORY OR OTHERWISE WITH RESPECT TO OUR SERVICES (INCLUDING ALL CONTENT CONTAINED THEREIN), INCLUDING, WITHOUT LIMITATION, ANY IMPLIED WARRANTIES OF SATISFACTORY QUALITY, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE OR NON-INFRINGEMENT. MATCH DOES NOT REPRESENT OR WARRANT THAT (A) OUR SERVICES WILL BE UNINTERRUPTED, SECURE, OR ERROR FREE, (B) ANY DEFECTS OR ERRORS IN OUR SERVICES WILL BE CORRECTED, OR (C) THAT ANY CONTENT OR INFORMATION YOU OBTAIN ON OR THROUGH OUR SERVICES WILL BE ACCURATE. FURTHERMORE, MATCH MAKES NO GUARANTEES AS TO THE NUMBER OF ACTIVE USERS AT ANY TIME; USERS’ ABILITY OR DESIRE TO COMMUNICATE WITH OR MEET YOU, OR THE ULTIMATE COMPATIBILITY WITH OR CONDUCT BY USERS YOU MEET THROUGH THE SERVICES.

MATCH TAKES NO RESPONSIBILITY FOR ANY CONTENT THAT YOU OR ANOTHER USER OR THIRD PARTY POSTS, SENDS, OR RECEIVES THROUGH OUR SERVICES NOR DOES MATCH TAKE ANY RESPONSIBILITY FOR THE IDENTITY, INTENTIONS, LEGITIMACY, OR VERACITY OF ANY USERS WITH WHOM YOU MAY COMMUNICATION THROUGH MATCH. ANY MATERIAL DOWNLOADED OR OTHERWISE OBTAINED THROUGH THE USE OF OUR SERVICES IS ACCESSED AT YOUR OWN DISCRETION AND RISK. MATCH IS NOT RESPONSIBLE FOR ANY DAMAGE TO YOUR COMPUTER HARDWARE, COMPUTER SOFTWARE, OR OTHER EQUIPMENT OR TECHNOLOGY INCLUDING, BUT WITHOUT LIMITATION, DAMAGE FROM ANY SECURITY BREACH OR FROM ANY VIRUS, BUGS, TAMPERING, FRAUD, ERROR, OMISSION, INTERRUPTION, DEFECT, DELAY IN OPERATION OR TRANSMISSION, COMPUTER LINE OR NETWORK FAILURE, OR ANY OTHER TECHNICAL OR OTHER MALFUNCTION.
...
Match will terminate the accounts of repeat infringers.
13. ADS AND THIRD-PARTY CONTENT

Like many subscription-based services, there are ads on our websites.

Our Services may contain advertisements and promotions offered by third parties and links to other websites or resources. Match may also provide non-commercial links or references to third parties within its content. Match is not responsible for the availability (or lack of availability) of any external websites or resources or their content. Furthermore, Match is not responsible for, and does not endorse, any products or services that may be offered by third-party websites or resources. If you choose to interact with the third parties made available through our Services, such party’s terms will govern their relationship with you. Match is not responsible or liable for such third parties’ terms or actions.
14. LIMITATION OF LIABILITY.

Match’s liability is limited to the maximum extent by applicable law.

TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL MATCH, ITS AFFILIATES, EMPLOYEES, LICENSORS, OR SERVICE PROVIDERS BE LIABLE FOR ANY INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES, INCLUDING, WITHOUT LIMITATION, LOSS OF PROFITS, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM: (I) YOUR ACCESS TO OR USE OF OR INABILITY TO ACCESS OR USE THE SERVICES, (II) THE CONDUCT OR CONTENT OF OTHER USERS OR THIRD PARTIES ON, THROUGH, OR FOLLOWING USE OF THE SERVICES; OR (III) UNAUTHORIZED ACCESS, USE, OR ALTERATION OF YOUR CONTENT, EVEN IF MATCH HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN NO EVENT WILL MATCH’S AGGREGATE LIABILITY TO YOU FOR ALL CLAIMS RELATING TO THE SERVICES EXCEED THE AMOUNT PAID, IF ANY, BY YOU TO MATCH FOR THE SERVICES WHILE YOU HAVE AN ACCOUNT.
...
If you are dissatisfied with our Services for any reason, please contact Match Customer Service first so that we can try to resolve your concerns without the need of outside assistance. If you choose to pursue a claim against Match, these terms will apply.
15a. ARBITRATION, CLASS-ACTION WAIVER, AND JURY WAIVER

If you pursue a legal claim against Match, you agree to arbitration (with limited exceptions).
...
Any claims that are not submitted to arbitration for any reason must be litigated in Dallas County, Texas (except for claims brought in small claims court, or where prohibited by law).

Except for claims that may be properly brought in a small claims court of competent jurisdiction in the county or other jurisdiction in which you reside or in Dallas County, Texas, all claims arising out of or relating to this Agreement, to our Services, or to your relationship with Match that for whatever reason are not submitted to arbitration will be litigated exclusively in the federal or state courts of Dallas County, Texas, U.S.A. You and Match consent to the exercise of personal jurisdiction of courts in the State of Texas and waive any claim that such courts constitute an inconvenient forum.
16. INDEMNITY BY YOU

You agree to indemnify Match if a claim is made against Match due to your actions.

You agree, to the extent permitted under applicable law, to indemnify, defend, and hold harmless Match, our affiliates, and their and our respective officers, directors, agents, and employees from and against any and all complaints, demands, claims, damages, losses, costs, liabilities, and expenses, including attorney’s fees, due to, arising out of, or relating in any way to your access to or use of our Services, Your Content, Your conduct toward other users, or your breach of this Agreement.
...
These Terms, with the Privacy Policy, Cookie Policy, and any Additional Terms Upon Purchase, contain the entire agreement between you and Match regarding the use of our Services. The Terms supersede all previous agreements, representations, and arrangements between us, written or oral. If any provision of these Terms is held invalid, illegal, or otherwise unenforceable, the remainder of the Terms shall continue in full force and effect. The failure of the Company to exercise or enforce any right or provision of these Terms shall not constitute a waiver of such right or provision. You agree that your Match account is non-transferable and all of your rights to your account and its content terminate upon your death, unless otherwise provided by law. Any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by us without restriction. No agency, partnership, joint venture, fiduciary or other special relationship or employment is created as a result of these Terms, and you may not make any representations on behalf of or bind Match in any manner.
