...
Content
    ...
    TCs:
        ...
        Prices, We Price Match, Genius program, and offers facilitated by a partner company
        Privacy and Cookies
...
The Genius rate is for members of the Booking.com Genius program. The Genius program is open to anyone that has an account on the Platform. There are no membership fees, and all you need to do to become a member is complete two (2) stays in two (2) years. The membership and the Genius rates are for that individual member and are non-transferable. Membership can also be linked to specific campaigns or incentives, as occasionally launched or communicated per Booking.com’s sole discretion.

The Genius program currently offers two (2) membership levels based upon the number of reservations made through the Booking.com platform, each with different levels of discount on selected properties and / or selected options (10% resp. 15%). Membership levels may vary and may be subject to change, at the sole discretion of Booking.com.
